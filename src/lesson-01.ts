export default class calculator {
     ...
     */
     users: Array<{name: string, email: string}> = [
        {name: "Babiagorai Riparievich Metell", email: "tarara@tarara.hu"},
        {name: "Jim Tom", email: "jimtom@tarara.hu"},
    ];
     ...
     */    
     products: Array<{name: string, price: number, stock: number, active: boolean}> = [
         {name: "Dogmeat", price: 33, stock: 10, active: true},
         {name: "Pickles", price: 22, stock: 54, active: false}
     ];
